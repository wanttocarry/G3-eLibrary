					...
					<div class="col-lg-12">
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal" action="/e-library/UserUpdateServlet"
									method="post">
